...
import { isV2Locale, type V2Locale, getV2UiCopy } from '@/lib/v2/locale';
    ...
    <>
      <section className="relative overflow-hidden bg-noir-950">
        <div className="absolute inset-0">
          {typeof hero.image === 'string' ? (
            <Image src={hero.image} alt="v2 hero" fill className="object-cover opacity-40" priority />
          ) : null}
        ...
        <div className="container-wide relative grid gap-10 py-24 md:grid-cols-[1.3fr_0.7fr] md:py-32">
          <div className="max-w-3xl">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                href={localizedPath(locale, String(hero.primaryCtaHref ?? '/offerte'))}
              ...
              <Link
                href={localizedPath(locale, String(hero.secondaryCtaHref ?? '/projecten'))}
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
            ...
            <p className="mt-4 text-4xl font-display font-bold text-white">v2</p>
            <p className="mt-2 text-sm leading-6 text-white/60">
              Public read/write endpoints zijn nu uitgesplitst. Admin-auth gebruikt server-side sessies.
            </p>
      ...
      <section className="container-wide py-8">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-4 text-display-md font-display font-bold text-noir-900">v2 projectreferenties</h2>
          </div>
          <Link href={localizedPath(locale, '/projecten')} className="text-sm font-semibold text-accent-700 transition hover:text-accent-900">
      ...
      <section className="container-wide py-16">
        <div className="rounded-[2rem] bg-accent-600 px-8 py-10 text-white">
          ...
          <Link
            href={localizedPath(locale, String(cta.primaryCtaHref ?? '/afspraak'))}
