      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="container-wide">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            {/* What we do */}
            <div className="bg-noir-50 p-10 rounded-2xl">
            ...
            <div className="bg-noir-50 p-10 rounded-2xl">
              ...
              <div className="mt-8 pt-6 border-t border-noir-200">
        ...
        <div className="container-wide">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {premieTypes.map((premie) => (
              <div key={premie.title} className="bg-white p-8 rounded-2xl hover:-translate-y-1 transition-all duration-300">
                <h3 className="text-xl font-display font-bold text-noir-900 mb-3">{premie.title}</h3>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-12">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-3 px-6 py-4 border border-noir-700 text-white font-semibold uppercase tracking-wide rounded-full hover:bg-white hover:text-noir-900 hover:border-white transition-all duration-300"
              >
                Mijn VerbouwPremie
