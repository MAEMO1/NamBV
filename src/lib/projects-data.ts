...
export const realProjects = [
  {
    ...
    surface: '180 m²',
    completionDate: '2024',
    shortDescription: 'Volledige transformatie van een gedateerde rijwoning tot een modern pareltje met witte gevel en strak interieur.',
  ...
  },
  {
    ...
    approachText: 'We startten met de dakwerken: nieuwe pannen, onderdak met OSB-platen en waterdichting. Parallel werkten we aan het interieur. De woonkamer kreeg een warme eiken vloer met ingebouwde spots. De eetkamer werd voorzien van designverlichting en nieuwe vloer. Een ingebouwde gashaard zorgt voor sfeer.',
  ...
  },
  {
    ...
    challengeText: 'Dit appartement in Parijs was volledig gestript en klaar voor afwerking. De vloerbalken lagen bloot, de elektriciteit moest vernieuwd worden en de muren waren kaal. De eigenaar wilde een warme, moderne afwerking met karakter.',
  ...
  },
  {
    ...
    challengeText: 'Deze stadswoning in de Visitatiestraat in Gent ondergaat een volledige transformatie. Het bestaande pand werd volledig afgebroken tot op de funderingen. De uitdaging is om op deze locatie een moderne, energiezuinige gezinswoning te realiseren.',
    ...
    mainImage: projectImages.visitatiestraat.main,
    images: {
      photos: projectImages.visitatiestraat.photos,
    },
  },
]
